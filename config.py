...
class Config:
    ...
    DEFAULT_ACTIVITY_LIMITS = {
        "吃饭": {"max_times": 3, "time_limit": 30, "max_users": 10},
        "小厕": {"max_times": 5, "time_limit": 10, "max_users": 3},
        "大厕": {"max_times": 3, "time_limit": 20, "max_users": 2},
        "抽烟": {"max_times": 5, "time_limit": 10, "max_users": 5},
    }
